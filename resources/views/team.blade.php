<x-layout>
    @props(['teams'])
    <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 my-10 mx-10">
        @foreach ($teams as $team)
            <div
                ...
                <img class="object-cover w-full h-56 md:h-64 xl:h-80" src="{{ $team['Image'] }}" alt="Person" />
                <div
                    ...
                    <p class="mb-4 text-xs text-gray-100">{{ $team['JobTitle'] }}</p>
                    <p class="mb-4 text-xs tracking-wide text-gray-400">
                        {{ $team['About'] }}
                    </p>
                    <div class="flex items-center justify-center space-x-3">
                        <a href="FaceBook" class="text-white transition-colors duration-300 hover:text-teal-accent-400">

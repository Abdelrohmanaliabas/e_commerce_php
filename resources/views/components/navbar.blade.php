            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        <x-navitem href="/" :active="request()->is('/')">
                            home
                        </x-navitem>
                        <x-navitem href="/contact" :active="request()->is('contact')">
                            contect
                        </x-navitem> <x-navitem href="/about" :active="request()->is('about')">
                            about
                        </x-navitem>
                        <x-navitem href="/card" :active="request()->is('card')">
                            card
                        </x-navitem>
                        <x-navitem href="/team" :active="request()->is('team')">
                            team
                        </x-navitem>
                    </div>
                </div>
